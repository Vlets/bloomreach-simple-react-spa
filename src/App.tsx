...
export default function App(props: RouteComponentProps) {
  ...
  const mapping = { /* Insert component mapping in here, for example 'News List': NewsList, where News List is the name of the component in the 
                    CMS and NewsList the name of your component class */ };
